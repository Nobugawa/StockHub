...
function App(){
 const [session,setSession]=useState(null),[stocks,setStocks]=useState([]),[screens,setScreens]=useState([]),[search,setSearch]=useState(''),[selected,setSelected]=useState(null),[showAdd,setShowAdd]=useState(false),[candidatesOpen,setCandidatesOpen]=useState(true),[loading,setLoading]=useState(true)
